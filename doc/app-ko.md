...
### 데이터 구조 안내서 (`data_structure_guide.py`)
- **3개 탭 인터페이스**: 전체 현황, GraphRAG, GraphDB 섹션
- **시스템 문서화**: 데이터 모델의 상세한 설명
- **실시간 통계**: 현재 노드, 엣지, 트리플 수
- **아키텍처 다이어그램**: 데이터 관계의 시각적 표현
